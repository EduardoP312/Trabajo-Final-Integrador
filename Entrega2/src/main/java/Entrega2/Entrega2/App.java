...
public class App 
{
	public static void main(String[] args) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine() && scanner2.hasNextLine()) {              // el While Se ejecutara hasta que no haya mas lineas.
        ...
        scanner2.close();
                                        ...
                                        //Aqui empieza el pronostico de Pedro
        //-------------------------------------------------------------------------------------------------------------
        
        
     // Abrir el archivo CSV
        File archivo3 = new File(rutaArchivo);
        File archivo4 = new File(rutaArchivo2);
        ...
        while (scanner3.hasNextLine() && scanner4.hasNextLine()) {              // el While Se ejecutara hasta que no haya mas lineas.
